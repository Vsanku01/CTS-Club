...
import 'package:cts_club/data.dart';
          ...
          backgroundColor: Colors.blueAccent,
            ...
            items: const [
              BottomNavigationBarItem(
                ...
                title: Text("LEFT",style: TextStyle(color: Colors.white),),
              ),
              BottomNavigationBarItem(
                icon: Icon(Icons.format_align_center,color: Colors.white,),
                title: Text("CENTER",style: TextStyle(color: Colors.white),),
              ),
              BottomNavigationBarItem(
                icon: Icon(Icons.format_align_right,color: Colors.white,),
                title: Text("RIGHT",style: TextStyle(color: Colors.white),),
              ),
            ]),
        appBar: AppBar(
          title: Text('Tasks Timeline (FEB-DEC) '),
